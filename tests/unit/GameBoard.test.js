...
describe("GameBoard.vue", () => {
  ...
  /* He intentado testear tambien cuándo que se actualice el score cuándo le das a un topo, 
  pero lamentablemente peta al intentar llamar al navigator.vibrate(). Dejo el test como 
